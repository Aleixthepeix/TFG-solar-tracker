...
\title{Simulación, desarrollo y validación de arquitecturas robóticas paralelas para el tratamiento superficial y sinterización mediante energía solar}
\author{Aleix Tellols Ruiz}
...
\email{Aleix.Tellols@alu.uclm.es}
...
\gitrepo{https://github.com/Aleixthepeix/TFG-solar-tracker.git}
